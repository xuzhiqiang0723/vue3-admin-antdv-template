...
export const useFeatureList = [
  // 常用功能部分数据
  {
    // require('../../assets/useFeature1.png')    // 图片地址 vue2 写法
    url: new URL('../../assets/useFeature1.png', import.meta.url).href, // 图片地址 vue3 写法
    label: '快递作业', // 名称
    link: '/branches/operational', // 点击跳转去往地址
  },
  {
    url: new URL('../../assets/useFeature2.png', import.meta.url).href,
    label: '运输任务',
    link: '/transport/transport-task',
  },
  {
    url: new URL('../../assets/useFeature3.png', import.meta.url).href,
    label: '线路管理',
    link: '/transport/line-manage',
  },
  {
    url: new URL('../../assets/useFeature4.png', import.meta.url).href,
    label: '车辆管理',
    link: '/transit/vehicle',
  },
  {
    url: new URL('../../assets/useFeature5.png', import.meta.url).href,
    label: '司机管理',
    link: '/transit/driver',
  },
  {
    url: new URL('../../assets/useFeature6.png', import.meta.url).href,
    label: '运费查询',
